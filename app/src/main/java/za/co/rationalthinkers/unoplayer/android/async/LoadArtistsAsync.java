...
import za.co.rationalthinkers.unoplayer.android.viewmodel.ArtistViewModel;

public class LoadArtistsAsync extends AsyncTask<String, Void, Boolean> {

    private WeakReference<ArtistViewModel> _model;
    private Context context;
    private ArrayList<Artist> artists = new ArrayList<>();

    public LoadArtistsAsync(ArtistViewModel model){
        this._model = new WeakReference<>(model);
    }

    @Override
    protected Boolean doInBackground(String... params) {
        ArtistViewModel model = _model.get();

        if(model != null){
            context = model.getContext();
            Cursor cursor = getArtistsCursor();
            ...
            if (cursor != null) {
                try{
                    while(cursor.moveToNext()) {
                        ...
                        artist.setName(name);
                        artist.setSongs(getSongsFromArtistId(id));
                        artist.setAlbums(getAlbumsFromArtistId(id));
    ...
    private List<Song> getSongsFromArtistId(String id){
    ...
    private List<Album> getAlbumsFromArtistId(String id){
