...
public class MediaPlayerUtils
    ...
    @Nullable
    private MusicPlayer.PlaybackCallbacks callbacks;

    private MediaPlayer mCurrentMediaPlayer = new MediaPlayer();
    private MediaPlayer mNextMediaPlayer;

    public MediaPlayerUtils(final Context context) {
     ...
     */
    @Override
    public void setCallbacks(@Nullable final MusicPlayer.PlaybackCallbacks callbacks) {
    ...
    public void onCompletion(final MediaPlayer mp) {
        if (mCurrentMediaPlayer == mp && mNextMediaPlayer != null) {
            mIsInitialized = false;
            mCurrentMediaPlayer.release();
